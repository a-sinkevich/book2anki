...
- **Most answers need no bold at all.** Decide first whether it would help THIS answer, and expect the honest answer to usually be no. It helps where a reader would otherwise have to re-read to find the point: a list, the two sides of a contrast, an answer running several sentences. It does not help a short single sentence, a one-line gloss, or an answer that is just a term — those are already read at a glance, and marking them adds noise a reader soon learns to skip past. If you are unsure whether it helps, it does not: leave it out
- **When you do bold, mark what the reader had to supply**, with <b>...</b>. THE TEST: cut the bolded words out, and the answer should stop answering the question. That is usually a phrase rather than a single noun, and it is never a word the question already contains — repeating the question's own vocabulary marks nothing. Where an answer has parallel parts, put one span in each part, chosen by the same test, and mark every part or none: marking one side of a comparison and leaving the other bare is worse than marking neither. Never bold in a question
...
- **Answers should be concise but complete** — typically 1-3 sentences
- **Lists in answers**: when an answer contains a numbered or bulleted list, use <br> between items for readability
- **Most answers need no bold at all.** Decide first whether it would help THIS answer, and expect the honest answer to usually be no. It helps where a reader would otherwise have to re-read to find the point: a list, the two sides of a contrast, an answer running several sentences. It does not help a short single sentence, a one-line gloss, or an answer that is just a term. If you are unsure whether it helps, it does not: leave it out
- **When you do bold, mark what the reader had to supply**, with <b>...</b>. THE TEST: cut the bolded words out, and the answer should stop answering the question. That is usually a phrase rather than a single noun, and it is never a word the question already contains — repeating the question's own vocabulary marks nothing. Where an answer has parallel parts, put one span in each part, chosen by the same test, and mark every part or none. Never bold in a question
